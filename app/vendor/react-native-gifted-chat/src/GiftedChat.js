...
class GiftedChat extends React.Component {
  ...
  scrollToTop(yval, animated = true) {
    this._messageContainerRef.scrollTo({
      y: yval,
      animated,
    })
          ...
          <View
            ...
            onLayout={(e) => {
              ...
              if (this.getIsFirstLayout() === true) {
                ...
                if (this.props.isFirstTimeOpeningApp) {
                  this.scrollToTop(e.nativeEvent.layout.height + (Platform.OS === 'android' ? 50 : -160))
                }
              }
            }}
          >
...
GiftedChat.propTypes = {
  ...
  isFirstTimeOpeningApp: React.PropTypes.bool,
};
