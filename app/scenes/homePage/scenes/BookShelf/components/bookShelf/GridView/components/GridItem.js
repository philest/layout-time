...
const alignment = (index, numItems, itemsPerRow) => {
  return ((index + numItems) % itemsPerRow) ?  'flex-start' : 'flex-end'
}

const padGen = (index, numItems, itemsPerRow) => {
  const s = SPACE_BETWEEN_COVERS/2
  return ((index + numItems) % itemsPerRow) ?  {marginLeft:s} : {marginRight:s}
}
      ...
      <View style={[styles.rowContainer, {
        ...
        <View style={[styles.thumbContainer, {
          ...
          <TouchableOpacity
            ...
            onPress={()=>this.props.onPress(this.props.awsKey)} >
