...
// const onecolor    = require('./node_modules/onecolor')
...
const SPINE_IMG   = `${__dirname}/assets/${path.basename(ORIGINAL_IMG)}.spine.jpg`
const FACE_IMG   = `${__dirname}/assets/${path.basename(ORIGINAL_IMG)}.face.jpg`
